// frontend/src/services/multi-webrtc.ts
...
class MultiWebRTCService {
  ...
  private log(...args: any[]) {
    if (this.debug) {
      console.log(`[WebRTC:${this.cameraId || 'unknown'}]`, ...args);
    }
  }

  // Error logging helper
  private error(...args: any[]) {
    console.error(`[WebRTC ERROR:${this.cameraId || 'unknown'}]`, ...args);
  }
...
// Export the class for creating new instances and a singleton for backward compatibility
export { MultiWebRTCService };
export const multiWebRTCService = new MultiWebRTCService();
export default multiWebRTCService;